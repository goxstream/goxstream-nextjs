...
export default function AdminAnimeGenresPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Genres</h1>
        <p className="text-muted-foreground mt-1">Manage anime genre tags and classifications.</p>
      </div>
      ...
      <Empty className="border border-dashed border-border bg-muted/20 p-12 rounded-xl">
        <EmptyHeader>
          ...
          <EmptyTitle>Genre Management</EmptyTitle>
          <EmptyDescription>
            Genre management interface is currently under development.
          </EmptyDescription>
        </EmptyHeader>
      </Empty>
    </div>
