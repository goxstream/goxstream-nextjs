/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: d37968188054136b2ff4d67ac413e082)
...
interface __BaseEnv_CloudflareEnv {
	...
	DB: D1Database;
	EMAIL: SendEmail;
	TELEMETRY_DATASET: AnalyticsEngineDataset;
	INGEST_QUEUE: Queue;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	GOX_ADMIN_SLUG: "backstage";
	BETTER_AUTH_URL: "https://goxstream-nextjs.dyzulk.workers.dev";
	NEXTJS_ENV: string;
	NEXT_PRIVATE_MINIMAL_MODE: string;
	GOXSTREAM_CONTAINER: DurableObjectNamespace<import("./src/cloudflare/worker").GoxstreamContainer>;
	WORKER_SELF_REFERENCE: Service<typeof import("./src/cloudflare/worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/worker");
		durableNamespaces: "GoxstreamContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOX_ADMIN_SLUG" | "BETTER_AUTH_URL" | "NEXTJS_ENV" | "NEXT_PRIVATE_MINIMAL_MODE">> {}
}
